...
from data.healthcare_utils import MyW2VTransformer, MyKerasClassifier, \
    create_model
...
patients = pd.read_csv(os.path.join(str(get_project_root()), "data", "patients.csv"), na_values='?')
histories = pd.read_csv(os.path.join(str(get_project_root()), "data", "histories.csv"),
                        na_values='?')
