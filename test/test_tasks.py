...
from user_interviews.utils import get_project_root


ADULT_SIMPLE_TASK_NB = os.path.join(str(get_project_root()), "user_interviews", "example-task-with-solution.ipynb")
COMPAS_TASK_NB = os.path.join(str(get_project_root()), "user_interviews", "task-1-solution.ipynb")
HEALTHCARE_TASK_NB = os.path.join(str(get_project_root()), "user_interviews", "task-2-solution.ipynb")
